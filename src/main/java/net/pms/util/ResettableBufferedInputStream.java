 ...
 * specifying a to small {@code marklimit}.<br>
 * <br>
...
public class ResettableBufferedInputStream extends BufferedInputStream {
	...
	/**
     * Creates a {@link ResettableBufferedInputStream} and saves its argument, the
	 ...
	 */
	public ResettableBufferedInputStream(InputStream in, int marklimit) {
		super(in);
    ...
    /**
     * Creates a {@link ResettableBufferedInputStream} with the specified buffer
     ...
     */
	public ResettableBufferedInputStream(InputStream in, int size, int marklimit) {
		super(in, size);
		this.marklimit = marklimit;
		markpos = 0;
	}
     ...
     * @see ResettableBufferedInputStream#reset()
     */
	@Override
     ...
     * @see ResettableBufferedInputStream#mark(int)
     */
	@Override
