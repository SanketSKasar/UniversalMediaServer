...
public class Image implements Serializable {
	...
	/**
	 * Converts an image to a {@link Image}. Format support is limited
	...
	public static Image toImage(
		...
		return ImagesUtil.transcodeImage(
			imageByteArray, width, height, scaleType, outputFormat, true, false, false, padToSize);
	}
	...
	/**
	 * @return The {@link ColorModel} for this image.
	 */
