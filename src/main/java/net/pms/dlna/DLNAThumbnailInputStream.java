...
public class DLNAThumbnailInputStream extends ByteArrayInputStream {
	 ...
	 */
	public DLNAThumbnailInputStream scale(DLNAImageProfile imageProfile, boolean updateMetadata, boolean padToSize) throws IOException {
	...
	public DLNAThumbnail getThumbnail() {
		return new DLNAThumbnail(buf, imageInfo, false);
	}
	...
	/**
	 * @return The {@link ColorModel} for this thumbnail.
	 */
	public ColorModel getColorModel() {
		return imageInfo != null ? imageInfo.getColorModel() : null;
	}
